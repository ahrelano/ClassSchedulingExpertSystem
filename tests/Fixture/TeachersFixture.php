...
class TeachersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'middle' => ['type' => 'string', 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'loads' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '6', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'middle' => 'Lorem ipsum dolor sit ame',
            'position_id' => 1,
            'subject_id' => 1,
            'loads' => 1,
            'created' => '2017-07-09 04:07:44',
            'modified' => '2017-07-09 04:07:44'
        ],
    ];
}
