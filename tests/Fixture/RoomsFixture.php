...
class RoomsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'room' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'grade' => 1,
            'created' => '2017-07-09 12:01:33',
            'modified' => '2017-07-09 12:01:33'
        ],
    ];
}
